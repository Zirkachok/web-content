+++
title      = "Mes impressions sur le travail au Japon"
date       = "2017-01-16T15:18:23+01:00"
tags       = ["Divers"]
categories = ["misc"]
menu       = ""
...
Randy https://en.wikipedia.org/wiki/Randy_Bush_(scientist)
...
J'ai créé ce blog pour deux raisons:

Tout d'abord afin d'écrire et partager sur des domaines qui m'intéressent , notamment la robotique, les systèmes embarqués, le traitement d'image et la programmation en général. Ensuite ce blog est pour moi l'occasion de présenter les projets sur lesquels je travaille (ou ai travaillé), et de discuter de mes trouvailles et bidouilles technologiques.

Ce blog me sert également de CV numérique, je compte y déposer mes références. Déjà dans l'optique d'une recherche d'emploi dans 6 mois, mais aussi à plus long terme pour me faire un espace où se cotoient mes références personnelles et professionnelles.

Étant à la recherche d'un site plutôt dynamique je vous invite à venir me dire ce que vous pensez de mes articles (commentaire ou email) et à discuter de manière générale autour de nos passions communes.

J'y parlerai informatique, l'accent sera donné sur le monde de l'embarqué et tout ce qui gravite autour, mais aussi 
J'y référencerai mes découvertes
